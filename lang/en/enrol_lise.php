...
$string['pluginname'] = 'Lise database';
...
$string['settingsheaderdb'] = 'Lise database connection';


$string['dburl'] = 'SQL connect URL';
$string['dburl_desc'] = 'Full url to connect to postgreSQL database.';
...
$string['dbport'] = 'Port';
$string['dbport_desc'] = 'Generally 5432';
